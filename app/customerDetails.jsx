...
export default function CustomerDetails() {
  ...
  var rrr = 0
  console.log(personName, personType, personId)
  useEffect(() => {
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.bottomButtonsRow}>
          <TouchableOpacity style={styles.receivedButton} onPress={() => {
            router.push({
              pathname: '/transaction', params: { transactionType: "you_got", transaction_for: "customer", id: personId, personName: personName }
            })
          }}>
          ...
          <TouchableOpacity style={styles.givenButton} onPress={() => {
            router.push({
              pathname: '/transaction', params: { transactionType: "you_gave", transaction_for: "customer", id: personId, personName: personName }
            })
          }}>
